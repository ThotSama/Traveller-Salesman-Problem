...
#ne pas mettre de points lance le programme avec 15 points aléatoires
manager = Manager(graph)
antColonyTypes = ["ACS", "ELITIST", "MAX-MIN"]

#change mode
#manager.ChangeAntColonyVariation("ACS")
manager.ChangeAntColonyVariation("ELITIST")
#manager.ChangeAntColonyVariation("MAX-MIN")

# 0 = bruteForce, 1 = lexicagraphic order, 2 = genetic algorithm, 3 = ant ACS, 4 = ant ELITIST, 5 = MAX-MIN
selectedIndex = 0
